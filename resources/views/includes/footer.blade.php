        ...
        <div class="wrapper">
            <div class="overflow">
                <ul class="footer-nav-menu">
                    ...
                    @endforeach
                    @endif
                    <li><a href="{{url('blog')}}"><span class="app-footer-links">Blog</span></a></li>
...
<div id="progress-notifier" class="modal fade " tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
    <div class="modal-dialog modal-large">
        <div class="modal-content app-review-request-importer" style="padding: 15px;">
            ...
            <div class="adminModalImport__title"><h3 style="color: red;">MY HEALTH SQUAD WELCOMES YOU!</h3></div>
            <p style="padding:0 10px;">Thank you for joining the <strong>My Health Squad</strong> growing community.</p>
            @if(@Auth::user()->first_popup == 0)
                <!--<div class="adminModalImport__title"><h3>MY HEALTH SQUAD WELCOMES YOU!</h3></div>
                <h4 style="padding:10px;">Thank you for joining the My Health Squad growing community.</h4>-->
            ...
            @endif
            <p style="padding:0 10px;">Like you, we are deeply passionate about <strong>health</strong> and <strong>wellness</strong> and we are very excited to help you grow your business and help you make meaningful connections. We are constantly working hard to add more tools for you. In the meantime, here are a few suggestions to enhance your own profile:</p>
            ...
            <div class="ctChecklistTasks__item pt2 pb2">
                ...
                <div class="rctChecklistTasks__description" style="width:80% !important">
                    <p style="font-size:18px;padding-top:10px;font-weight:bold;">
                        <a href="{{url('gallery')}}">Upload up to 8 pictures of you and your business.</a>
                    </p>
                </div>
                @endif
                ...
                <div class="rctChecklistTasks__description" style="width:80% !important">
                    <p style="font-size:18px;padding-top:10px;font-weight:bold;">
                        <a href="{{url('owners')}}">Add members of your team with a picture and a short bio.</a>
                    </p>
                </div>
                @endif
                ...
                <div class="rctChecklistTasks__description" style="width:80% !important">
                    <p style="font-size:18px;padding-top:10px;font-weight:bold;">
                        <a href="{{url('reviews')}}">Request and add reviews to 5 clients about your business and earn “MHS All-Star Team” medals.</a>
                    </p>
                </div>
                @endif
            </div>
