...
<body>
    ...
    <div class="wrapper-800">
        <div class="ml60 mr60">
            <h2 class="mt10 th1 text-center">Maria and cesario</h2>
            <p class="text-center">have requested your mailing address</p>
            <hr class="mt25 mb25">
            <p>We'd like to send you some exciting mail! Please enter your address below.</p>
            <form class="app-tools-rsvp" data-type="address">
                <input type="hidden" name="confirm" value="44ebe42cd12794a113c3b9f314326c0e5edb11132230e2778eac53af4d8c23e75645bc7f3be50ae2MTIxOTA2">
                <input type="hidden" name="idUser" value="701165">
                <input type="hidden" name="token" value="MWI2YTQ2MzYzZTQxYTkzOWJjZWNiZTM2ZjNlNWNlYzA=">
                <div class="pure-g row">
                    <div class="pure-u-2-4">
                        <div class="unit">
                            <div class="textfield">
                                <label class="textfield__label" for="direccion">Address</label>
                                <input class="textfield__input" type="text" name="direccion" data-redesign="redesign">
                            </div>
                        </div>
                    </div>
                    <div class="pure-u-2-4">
                        <div class="unit">
                            <div class="textfield">
                                <label class="textfield__label" for="codPostal">Postal code</label>
                                <input class="textfield__input" type="text" name="codPostal" data-redesign="redesign">
                            </div>
                        </div>
                    </div>
                    <div class="pure-u-2-4">
                        <div class="unit">
                            <div class="textfield textfield--focused">
                                <label class="textfield__label textfield__label--float-above" for="menu">Country</label>
                                <select class="textfield__input textfield__input--select" name="Pais" data-msgerror="Choose a country" data-redesign="redesign">
                    ...
                    <div class="pure-u-2-4">
                        <div class="unit pt5">
                            <div class="app-textfield textfield">
                                <label class="textfield__label" for="txtStrPoblacion">City/Town</label>
                                <input class="textfield__input app-modif-poblacion-edit" name="txtStrPoblacion" id="txtStrPoblacion" type="text" autocomplete="off" data-suffix="default" tabindex="4" data-msgerror="Enter your town/city and select it from the list" data-redesign="redesign" onblur="common_searchPoblacionReset(this)" onkeyup="common_searchPoblacion(this, this.form.Pais.value, null, false);">
                ...
                <div class="pure-g">
                    <div class="pure-u-3-5">
                        <div class="formConditions__wrapper formConditions__wrapper--inline formConditions__inline app-textfield-validate textfield--block app-wrapper-legal-terms">
                            <input type="hidden" name="showCheckBox" value="1">
                            <span class="mr5 icon icon-white-check checkbox-check checkbox-check-grey checkbox-small app-mobile-check-toggle">
                                <div class="icheckbox_minimal" style="position: relative;">
                                    <input id="app-check-legal-terms" name="checkLegalTerms" type="checkbox" data-msgerror="You must accept the Terms of Use and privacy policy." data-redesign="redesign" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;">
                            ...
                            <div class="formConditions__content">
                                I accept WeddingWire's <a href="https://www.weddingwire.ca/legal-terms.php" class="underline" target="_blank">Terms of Use</a> and <a href="https://www.weddingwire.ca/legal/privacy.php" class="underline" target="_blank">Privacy Policy</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mt50 mb50 text-center">
                    <input class="btn-flat red" type="submit" value="Send address">
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="layer-redirect" id="layerRedirect" style="display: none;">
