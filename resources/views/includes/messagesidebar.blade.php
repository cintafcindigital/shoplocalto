<div class="mr40">
    ...
    <nav class="adminAside app-va-folders-side-nav folder_list">
        ...
        <a class="adminAside__item {{ Request::is('messages') ? 'active' : '' }}" href="{{url('messages')}}">
          Inbox <span class="adminAside__counter">{{ $messageCount['inbox'] }}</span>
        </a>

        <a class="adminAside__item {{ Request::is('messages-unread') ? 'active' : '' }}" href="{{url('messages-unread')}}">
          Unread <span class="adminAside__counter">{{ $messageCount['unread'] }}</span>
        </a>

        <a class="adminAside__item {{ Request::is('messages-read') ? 'active' : '' }}" href="{{url('messages-read')}}">
          Read <span class="adminAside__counter">{{ $messageCount['read'] }}</span>
        </a>

        <a id="0_sidebarstatus" class="app-va-folders-side-status adminAside__item adminBullet--double {{ Request::is('messages-pending') ? 'active' : '' }} @if(isset($data['message_details']->reply_status) && $data['message_details']->reply_status == 0) active @endif" href="{{url('messages-pending')}}" data-status="0">
          <i class="adminBullet adminBullet--orange"></i>
          Pending <span class="adminAside__counter app-va-folders--counter">{{ $messageCount['pending'] }}</span>
        </a>

        <a id="1_sidebarstatus" class="app-va-folders-side-status adminAside__item adminBullet--double {{ Request::is('messages-replied') ? 'active' : '' }} @if(isset($data['message_details']->reply_status) && $data['message_details']->reply_status == 1) active @endif" href="{{url('messages-replied')}}" data-status="1">
          <i class="adminBullet adminBullet--blue"></i>
          Replied <span class="adminAside__counter app-va-folders--counter">{{ $messageCount['replied'] }}</span>
        </a>

        <a id="3_sidebarstatus" class="app-va-folders-side-status adminAside__item adminBullet--double {{ Request::is('messages-booked') ? 'active' : '' }} @if(isset($data['message_details']->reply_status) && $data['message_details']->reply_status == 3) active @endif" href="{{url('messages-booked')}}" data-status="3">
          <i class="adminBullet adminBullet--green"></i>
          Booked <span class="adminAside__counter app-va-folders--counter">{{ $messageCount['booked'] }}</span>
        </a>

        <a id="2_sidebarstatus" class="app-va-folders-side-status adminAside__item adminBullet--double {{ Request::is('messages-discarded') ? 'active' : '' }} @if(isset($data['message_details']->reply_status) && $data['message_details']->reply_status == 2) active @endif" href="{{url('messages-discarded')}}" data-status="2">
          <i class="adminBullet adminBullet--red"></i>
          Discarded <span class="adminAside__counter app-va-folders--counter">{{ $messageCount['discarded'] }}</span>
        </a>
    </nav>
    ...
    <nav class="adminAside contest_list">
       <a class="adminAside__item {{ Request::is('entries') ? 'active' : '' }}" href="{{url('entries')}}">
    ...
    <nav class="adminAside tools_list">
       <a class="adminAside__item {{ Request::is('messages-setting') ? 'active' : '' }}" href="{{url('messages-setting')}}">
       ...
       <a class="adminAside__item {{ Request::is('messages-templates') ? 'active' : '' }}" href="{{url('messages-templates')}}">
