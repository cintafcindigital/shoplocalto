...
<style type="text/css">
  ...
  <!-- SLIDER SECTION START -->
        <section id="slider-seciton">
                ...
                <div id="myCarousel" class="carousel slide inner-slider about-us" data-ride="carousel" style="background:url({{ URL::asset('public/sliders/'.$mainPage['image']) }}) center center;">
                    <!-- Indicators -->                   
                    <!-- Wrapper for slides -->
       ...
       <div class="wrapper wrapper--blood text-justify" style="padding: 3% 0%;font-size: 18px;">
        <div class="row" style="margin-bottom: 2%;">
          ...
          <div class="col-sm-4">
            <div class="card">
                <a href="#">
                <img src="{{ URL::asset('public/sliders') }}/{{$pageData->image}}" alt="Avatar">
              </a>
              <div class="card-container">
                <a href="#"><h4>{{$pageData->title}}</h4></a>
                <p></p> 
              </div>
            </div>
          </div>
        ...
        <div class="row hidden">
          <div class="col-sm-12"><h2>Other Officials :- </h2></div>
          <div class="col-sm-2"></div>
          @foreach($bios as $bio)
            <div class="col-sm-4">
              <div class="card">
                <a href="{{url('bio/'.$bio->url)}}" class="card-mg-tag">
