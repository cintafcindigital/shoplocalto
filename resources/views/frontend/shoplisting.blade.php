                        ...
                        <div class="list-main-wrap-header fl-wrap fixed-listing-header">
                            <div class="container">
                                ...
                                <div class="list-main-wrap-title">
                                    <h2>Results For : <span>{{$loc}} </span></h2>
                                </div>
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            ...
                                            <img src="{{asset('vendors/VENDOR_'.$shop->vendor_id.'/'.$shop->featured_image)}}" alt=""> 
                                            </a>
                                            <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('vendors/VENDOR_'.$shop->vendor_id.'/'.$shop->profile)}}" alt=""></a>
                                                <span class="avatar-tooltip">Added By  <strong>{{$shop->contact_person}}</strong></span>
                                            </div>
                                        ...
                                        <div class="geodir-category-content fl-wrap">
                                            <div class="geodir-category-content-title fl-wrap">
                                                <div class="geodir-category-content-title-item">
                                                    <h3 class="title-sin_map"><a href="listing-single.html">{{$shop->business_name}}</a><span class="verified-badge"><i class="fal fa-check"></i></span></h3>
                                                    <div class="geodir-category-location fl-wrap"><a href="#5" class="map-item"><i class="fas fa-map-marker-alt"></i> {{$shop->business_address}}</a></div>
                                                </div>
                                            </div>
                                            <div class="geodir-category-text fl-wrap">
                                                <p class="small-text">{{$shop->business_detail}}</p>
                                            ...
                                            <div class="geodir-category-footer fl-wrap">
                                                ...
                                                <div class="geodir-opt-list">
                                                    <ul class="no-list-style">
                                                        ...
                                                        <li>
                                                            <div class="dynamic-gal gdop-list-link" data-dynamicPath="[{'src': '{{asset('images/frontend/all/1.jpg')}}'},{'src': '{{asset('images/frontend/all/1.jpg')}}'}, {'src': '{{asset('images/frontend/all/1.jpg')}}'}]"><i class="fal fa-search-plus"></i><span class="geodir-opt-tooltip">Gallery</span></div>
                                                        </li>
                                                    </ul>
                                                </div>
