                              ...
                              <tr>
                                 <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                    <span class="im">
                                       ...
                                       <!-- <h2 style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#2f3133;font-size:17px;font-weight:bold;margin-top:0;text-align:left">Thank you for registering on Perfect Wedding Day!</h2> -->
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">We have received your payment for {{'$'.$pay_amount}} that you submitted on {{date_format(date_create($invData['subscription_date']),'d M Y')}}. The payment has been authorized and approved.</p>
                                       ...
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left"><b>Invoice Number :</b> {{$invData['invoice_id']}}</p>
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left"><b>Due Date :</b> {{date_format(date_create($invData['due_date']),'d M Y')}}</p>
                                       ...
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                          <b>Now you get verification mail to verify your account.</b>
                                       </p>
                                       @else
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left"><b>Update your account :</b> 
                                          <a href="{{$updLink}}">Click here to Update</a>
                                       </p>
                                       @endif
