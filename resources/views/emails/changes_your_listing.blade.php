                              ...
                              <tr>
                                 <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                    <span class="im">
                                       ...
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">Just a friendly heads up that changes have been made to your profile. If you did not authorize these changes and feel someone accessed your account without permission, please let us know right away.</p>
                                       ...
                                       <p style="font-size: 12px;"><i>Unsubscribe from My Health Squad emails</i><a href="{{url('email-unsubscribe/'.(isset($toEmail)?encrypt($toEmail):''))}}" target="_blank" style="text-decoration: none;"> Click here</a></p>
                                    </span>
