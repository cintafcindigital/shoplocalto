						...
						<tbody>
							<tr>
								<!-- <td style="padding:0px;padding-bottom:10px" valign="top" align="center">
									<span style="font-size:11px;color:#9c9c9c">{{$name}} wants to know more about @if($roleType == 'admin') health professional's @else your @endif services</span>
								</td> -->
							</tr>
						</tbody>
					</table>
								...
								<td valign="top" align="center">
									...
									@if($roleType != 'admin')
										<table style="border-bottom:1px solid #e8e8e8" width="100%" cellspacing="0" cellpadding="0">
											<tbody>
												<tr>
													<td style="padding:5px 30px 10px 30px"><span>Bonjour!</span></td>
												</tr>
												<tr>
													<td style="padding:0px 30px 10px 30px" align="left">
														<span>Un client potentiel a demandé des informations sur votre entreprise via votre inscription gratuite sur Mon Équipe Santé. Si vous souhaitez réclamer le client et en obtenir davantage, veuillez cliquer ici pour voir les abonnements.  ( <a href="{{url('payment-lead-details').'/'.$vendor_id}}" target="_blank">Réclamation / Mise à niveau</a> ).</span>
													</td>
												</tr>
											</tbody>
										</table>
										<table style="border-bottom:1px solid #e8e8e8" width="100%" cellspacing="0" cellpadding="0">
											<tbody>
															...
															<tbody>
																<tr>
																	<td style="padding:10px 30px" valign="top" align="left">
																		<b style="font-size:17px;">Les détails du client potentiel comprendront: </b>
																	</td>
																</tr>
																<tr>
																	<td style="padding:5px 30px" valign="top" align="left">
																		<b>Nom :</b><span> {{$name}}</span>
																	</td>
																</tr>
																<tr>
																	<td style="padding:5px 30px" valign="top" align="left">
												...
												<tr>
													<td style="padding:10px 30px" align="left">
														<span>Mon Équipe Santé est une équipe qui se distingue par son exclusivité et son intérêt sans cesse grandissant par la santé. Nous serions heureux de vous aider à développer votre entreprise et à établir des liens significatifs.</span>
													</td>
												</tr>
												<tr>
													<td style="padding:5px 30px" align="left">
														<b>Vivez en bonne santé et prospérez!</b>
													</td>
												</tr>
												<tr>
													<td style="padding:0px 30px 20px 30px" align="left">
														<b>Mon Équipe Santé. </b>
													</td>
												</tr>
											</tbody>
										</table>
										<table width="100%" cellspacing="0" cellpadding="0">
											<tbody>
												<tr>
													<td style="padding:20px" align="center">Se désabonner des e-mails de Mon Équipe Santé. <a href="{{url('/')}}" target="_blank">(lien)</a></td>
												</tr>
											</tbody>
										</table>
									@else
							...
							<tr>
								<td style="padding:15px" valign="top" align="center">
									<span style="font-size:11px;color:#6c6c6c;line-height:18px">
										<a style="color:#8c8c8c;" href="javascript:;">Manage your preferences</a> | <a style="color:#8c8c8c;" href="javascript:;">Unsubscribe from all myhealthsquad<span>.</span>ca marketing emails</a> <br>You will continue to receive transactional and account-related electronic messages from myhealthsquad<span>.</span>ca
