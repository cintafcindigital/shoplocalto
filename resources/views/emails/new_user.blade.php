                              ...
                              <tr>
                                 <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                    <span class="im">
                                       ...
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">Thank you for joining My Health Squad Blooming Community.<br><br>Our goal is to increase your visibility to the marketplace. As you are well aware, clients are still facing challenges to find you and other health professionals. We want to build the best tool to help you grow your brand and your business and make meaningful connections. <br><br>Make sure your profile is complete and that all the information you provide is accurate and up-to-date. We are reviewing all new profiles, but do not hesitate to contact us if you have any questions; we will be happy to get back to you within 48 business hours.<br><br>A copy of your receipt and contract has been sent to you. <br><br>Welcome to the Team! 
                                          <br><br>My Health Squad !</p>
