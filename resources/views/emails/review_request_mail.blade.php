										...
										<tbody>
											<tr>
												<td style="padding:0 30px 10px 20px" align="center">
													<span style="font-family:'Avenir Next',Avenir,Arial,sans-serif;color:#444444;font-size:16px;font-weight:600"> How was {{ $vendorName }} ? </span>
												</td>
											</tr>
											<tr>
												<td style="padding:0 20px 20px 20px;border-bottom:1px solid #e5e5e5" align="center">
													<span style="font-size:14px;color:#444444;"> Share your experience and help other people. </span>
												</td>
											</tr>
										</tbody>
									</table>
										...
										<tbody>
											<tr>
												<td style="padding:30px 0 30px 0" align="center">
													<a href="{{ $reviewLink }}" target="_blank" style="border:1px solid #83021e;padding:10px 15px;border-radius:3px;background: #83021e;color:#FFFFFF;text-decoration:none;font-weight:bolder;"> Write a review </a>
												</td>
											</tr>
										</tbody>
									</table>
										...
										<tbody>
											<tr>
												<td style="font-size:11px;color:#666666" align="center">
													<a style="color:#8c8c8c" href="javascript:void(0)"> Manage your preferences </a> | <a style="color:#8c8c8c" href="{{url('email-unsubscribe/'.(isset($toEmail)?$toEmail:''))}}" target="_blank">Unsubscribe from all {{url('/')}} marketing emails</a><br>
													You will continue to receive transactional and account-related electronic messages from {{url('/')}}
