               ...
               <tbody>
                  <tr>
                     <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:25px 0;text-align:center">
                        <a href="#">
                         <img src="{{$url}}/public/images/logo.png" alt="My Health Squad Logo" style="width: 50%;">
                        </a>
                     </td>
                  </tr>
                  <tr>
                              ...
                              <tr>
                                 <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                    <span class="im">
                                       ...
                                       <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">You can Access your account to follow this simple process.</p>
                                       <p style="margin: 20px 0; text-align: center;">
                                          <a href="{{$url}}/guest-account-verify/{{ $id }}" style="display: inline-block; padding: 10px 18px; color: #fff; background-color: #00AEAF; text-transform: capitalize; text-decoration: none; font-size: 22px">
                                             Verify Email
                                          </a>
                                       </p>
