            ...
            <div class="card">
                <div class="card-body">
                    <div class="clearfix border-bottom mb-3">
                        <div class="float-left"><h1 class="d-inline-block font-weight-normal text-body mb-3">All Active Community Group</h1></div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="tasktable" class="table table-hover table-center mb-0 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="{{url('/community')}}/{{ $group->slug }}" target="_blank"><i class="fa fa-eye text-success"></i></a>&nbsp;&nbsp;
                        ...
                        @else
                        <h2 class="text-center">No Active Community Group Found</h2>
                        @endif
                    </div>
