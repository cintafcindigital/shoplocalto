            ...
            <div class="card">
                <div class="card-body">
                    <div class="clearfix border-bottom mb-3">
                        <div class="float-left"><h1 class="d-inline-block font-weight-normal text-body mb-3">All Community Group</h1></div>
                    ...
                    <div class="table-responsive">
                        ...
                        @else
                        <h2 class="text-center">No Community Group Found</h2>
                        @endif
                    </div>
