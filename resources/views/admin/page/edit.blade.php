            ...
            <div class="col-sm-12">
                <div class="row border-bottom mb-3">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">Edit Page</h1>
                    </div>
                ...
                <form class="form-horizontal" method="POST" action="{{ url('/admin/update_page') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                      ...
                      <div class="form-group {{ $errors->has('image_description') ? ' has-error' : '' }}">
                            <label>Image Description</label>
                             <textarea  name="image_description" id="image_description" data-validation-error-msg="Description is " data-validation="" class="form-control">{{$data['image_description']}}</textarea>
                     ...
                     <div class="form-group">
                            <label>Banner Image</label>
                                ...
                                <img src="{{URL::asset('public/sliders')}}/{{$data['image']}}" style="width:150px;">
                                @endif
                                @if ($errors->has('image'))
                                    <span class="help-block">
