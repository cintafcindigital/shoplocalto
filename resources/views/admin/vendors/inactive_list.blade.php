        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                @if(session()->has('success'))
                    <div class="app-hide-alert alert alert-success"> {{ session()->get('success') }} </div>
                @endif
                ...
                @endif
                <!--<div class="box-header pb-3 mb-3 border-bottom">-->
                <!--    <h5 class="text-body mb-3">Upload Bulk Guest Vendors Excel File</h5>-->
                <!--    <form action="{{url('admin/bulk_guest_vendor')}}" method="POST" enctype="multipart/form-data" style="display:flex;">-->
                <!--        @csrf-->
                <!--        <input type="file" name="uploadcsv" required>-->
                <!--        <button type="submit" class="btn btn-primary btn-sm" >Upload</button>-->
                <!--    </form>-->
                <!--</div>-->
                <div class="row">
                    <div class="col-sm-4 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">All Inactive Vendors</h1>
                    ...
                    <div class="col-sm-8 d-block d-sm-flex align-items-center justify-content-end mb-4 text-right">
                        ...
                        <a href="{{url('/admin/inactive-vendors')}}" class="btn d-block ml-auto btn-warning"><i class="fa fa-undo"></i></a>&nbsp;
                                    ...
                                    <table id="usertable" class="table table-center mb-0 ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="border-top:none;">Paid / Verified</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    if($cat->pay_status == 0) {
                                                        echo "<span style='color:#ff0b37;font-weight:bold;'>Not Paid</span><br/>";
                                                    } else {
                                                        echo "<span style='color:#2dca73;font-weight:bold;'>Paid</span><br/>";
                                                    }
                                                    if($cat->verified == 0) {
                                                        echo "<span style='color:#ff0b37;font-weight:bold;'>Not Verified</span>";
                                                    } else {
                                                        echo "<span style='color:#2dca73;font-weight:bold;'>Verified</span>";
                                                    }
                                                    $listing = $listCheck = '';
                                                    if($cat->freelisting == 'No') {
                                                        $listing = 'Paid Listed'; $listCheck = 'checked';
                                                    } else {
                                                        $listing = 'Freelisting';
                                                    } ?>
                                                </td>
...
<script>
    ...
    function getSearchData() {
        ...
        var category = $('select[name=search_category]').val();
        if(name != '') {
            window.location.href = "{{url('admin/inactive-vendors')}}?name="+name+"&page=1";
        } else if(category != '') {
            window.location.href = "{{url('admin/inactive-vendors')}}?category="+category+"&page=1";
        }
    }
