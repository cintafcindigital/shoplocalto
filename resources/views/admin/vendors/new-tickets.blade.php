            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-4 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">New Tickets</h1>
                    </div>
                    <div class="col-sm-8 d-block d-sm-flex align-items-center justify-content-end mb-4 text-right">
                        ...
                        <a href="{{url('/admin/new-tickets')}}" class="btn d-block ml-auto btn-warning"><i class="fa fa-undo"></i></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
...
<script>
    ...
    function getSearchData() {
        ...
        if(name != '') {
            window.location.href = "{{url('admin/new-tickets')}}?name="+name;
        } else if(subject != '') {
            window.location.href = "{{url('admin/new-tickets')}}?subject="+subject;
        }
    }
