                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <select name="country" id="country" class="form-control" required>
                                    @foreach($countries as $key=>$contry)
                                        <option value="{{$key}}" @if(old('country',@$vendorData->company_data->country) == $key) selected @endif>{{$contry}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select name="province" id="province" class="form-control" required>
                                  <option value="">-- select province --</option>
                                    @foreach($regions as $key)
                                        <option value="{{$key->state}}" @if(old('province',@$vendorData->company_data->province) == $key->state) selected @endif>{{$key->state}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <input type="text" name="city" placeholder="City/Town *" class="form-control" required autocomplete="off" list="region_list" onkeyup="get_city_town(this.value);" onclick="get_city_town(this.value,true);" value="{{old('city',@$vendorData->company_data->city)}}">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card card-body">
                           @if($vendorData->profile)
                            ...
                            @include('includes.image-crop-4',['width' => '300' ,'height' => '188','name' => 'profile_image','form' => 'addVendorForm'])
                        </div>
                        <div class="card card-body">
                            ...
                            @include('includes.image-crop-4',['width' => '285' ,'height' => '183','name' => 'featured_image','form' => 'addVendorForm'])
                        ...
                        <div class="form-col">
                            ...
                            <div class="form-group">
                                <label class="container-ul">
                                    Free
                                    <!--@if(@$vendorData->company_data->business_name){{@$vendorData->company_data->business_name}}@else{{old('business_name')}}@endif-->
                                    <input type="checkbox" value="1" name="free_parking" @if(old('paid_parking',$businfo->free_parking) == 1) checked @endif class="parking">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container-ul">
                                     Paid Parking
                                     <input type="checkbox" value="1" name="paid_parking" @if(old('paid_parking',$businfo->paid_parking) == 1) checked @endif class="paid-parking parking">
                                     <span class="checkmark"></span>
                                </label>
                                <label class="container-ul">
                                     Indoor Parking
                                     <input type="checkbox" value="1"  @if(old('indoor_parking',$businfo->indoor_parking) == 1) checked @endif name="indoor_parking" class="parking">
                                     <span class="checkmark"></span>
                                </label>
                                <label class="container-ul">
                                     No Parking
                                    <input type="checkbox" value="1" @if(old('no_parking',$businfo->no_parking)) checked @endif name="no_parking" class="no-parking parking">
                                    <span class="checkmark"></span>
                                 </label>
                            </div>
                        </div>
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                <label class="container-ul">
                                    ...
                                    <input type="checkbox" onclick="image_display('wheelchair_img',this.checked)" value="1" @if(old('wheelchair',$businfo->wheel_chair) == 1) checked @endif name="wheelchair">
                                    <span class="checkmark"></span>
                                 </label>
                            </div>
                        </div>
                        ...
                        <div class="form-col">
                            ...
                            <div class="form-group">
                                <label class="container-ul">
                                    ...
                                    <input type="checkbox" value="1" @if(old('motor_vehicle',@$businfo->motor_vehicle) == 1) checked @endif name="motor_vehicle">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container-ul">
                                     Health Benefit Plan
                                    <input type="checkbox" value="1" @if(old('health_benefit',@$businfo->health_benefit) == 1) checked @endif name="health_benefit">
                                    <span class="checkmark"></span>
                                 </label>
                                <label class="container-ul">
                                     Government Insurance
                                    <input type="checkbox" value="1" name="gov_insurance" @if(old('gov_insurance',@$businfo->gov_insurance) == 1) checked @endif>
                                    <span class="checkmark"></span>
                                 </label>
                                <label class="container-ul">
                                    Self Pay (Cash/Debit/Credit)
                                    <input type="checkbox" value="1" name="self_pay" @if(old('self_pay',@$businfo->self_pay) == 1) checked @endif>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container-ul">
                                     Personal Cheque accepted
                                    <input type="checkbox" value="1" @if(old('personal_cheque',@$businfo->personal_cheque)) checked @endif name="personal_cheque">
                                    <span class="checkmark"></span>
                                 </label>
                                <label class="container-ul">
                                     Financing Available - Differed payment
                                    <input type="checkbox" value="1" @if(old('finance_available',@$businfo->finance_available) == 1) checked @endif name="finance_available">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
