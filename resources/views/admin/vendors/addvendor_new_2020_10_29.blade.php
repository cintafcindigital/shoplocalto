...
<section class="vendor-step-wrap">
   <div class="container">
       ...
       <div class="alert alert-info alert-dismissible fade show">
        ...
        @endif
        <form action="{{ url()->current() }}" class="vendor-form-wrap form-submit-vendor" method="post" enctype="multipart/form-data" id="addVendorForm">
           {{ csrf_field() }}
            ...
            <div class="login-info-row">
                ...
                <div class="row">
                    ...
                    <div class="form-group {{ $errors->has('userImage') ? ' has-error' : '' }}">
                        <h3>Upload Image</h3>
                        <div class="img-size">(300px x 188px)</div>                     
                        @include('includes.image-crop-4',['width' => '300' ,'height' => '188','name' => 'userImage','form' => 'addVendorForm'])
