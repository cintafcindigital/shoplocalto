        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="box-header pb-3 mb-3 border-bottom">
                    <h5 class="text-body mb-3">Send Mail To All Freelisting Vendors</h5>
                    <a href="{{url('admin/freelisting-mail-template')}}" class="btn btn-sm btn-warning" target="blank">
                        <i class="fa fa-envelope"></i> Click Here to send Mail
                    </a>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-4 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">All Freelisting Vendors</h1>
                    ...
                    <div class="col-sm-8 d-block d-sm-flex align-items-center justify-content-end mb-4 text-right">
                        ...
                        <a href="{{url('/admin/freelisting-vendors')}}" class="btn d-block ml-auto btn-warning"><i class="fa fa-undo"></i></a>&nbsp;
...
<script>
    ...
    function getSearchData() {
        ...
        var category = $('select[name=search_category]').val();
        if(name != '') {
            window.location.href = "{{url('admin/freelisting-vendors')}}?name="+name+"&page=1";
        } else if(category != '') {
            window.location.href = "{{url('admin/freelisting-vendors')}}?category="+category+"&page=1";
        }
    }
