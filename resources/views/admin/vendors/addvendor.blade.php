                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="form-col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="location" placeholder="Location/Community *" class="form-control" required autocomplete="off" list="region_list" onkeyup="get_city_town(this.value);" onclick="get_city_town(this.value,true);" value="{{old('location')}}">
                        ...
                        <div class="form-col">
                            ...
                            <div class="form-group">
                                ...
                                <label class="container-ul">
                                    ...
                                    <input type="checkbox" value="{{$feature->id}}" name="feature1[]" @if(old('feature') == 1) checked @endif> 
            ...
            <div class="login-info-row">
                ...
                <div class="row">
                    ...
                    <div class="form-group {{ $errors->has('userImage') ? ' has-error' : '' }}">
                        ...
                        @include('includes.image-crop-4',['name' => 'userImage','width' => 750,'height' => 470])
