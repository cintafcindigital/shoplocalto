    ...
    <div class="pcoded-content container">
        <div class="row">
            <div class="col-sm-12">
        		...
        		<fieldset class="border p-2" style="color: black;margin-bottom: 12px;">
        			<!-- <legend style="width: auto;">Bulk Import vendor with .CSV File having the following fields:</legend> -->
        			<ul>
        				<li>
        					<h4>Bulk Import vendor with .CSV File having the following fields:</h4>
        					<ul>
		        				<li>Name (Name of the Contact Person)</li>
		        				<li>Business (Name of the Business)</li>
		        				<li>Address (Business Address excluding city and postal code)</li>
		        				<li>City</li>
		        				<li>Province</li>
		        				<li>Postal Code</li>
		        				<li>Phone</li>
        				...
        				<!-- <li></li> -->
						<li><h4>Click <a href="{{url('public/example/example_vendors.csv')}}" download="example_vendors.csv">here</a> to download the sample CSV file</h4></li>
        			</ul>
        		</fieldset>
                ...
                <form method="POST" enctype="multipart/form-data" action="{{url()->current()}}" id="data-import" class="">
                	@csrf
                	@if((!session()->has('success') || session()->has('last')))
                	...
                	@if((session()->has('success') || old('import') == 1) && !session()->has('last'))
                	<div class="form-group">
                		<div class="row">
                			<div class="col-sm-3">
                				<label>Random Description</label>
                			</div>
                			<div class="col-sm-9">
                				<div class="row">
	                				@for($i = 1;$i <= 5;$i++)
	                				<div class="col-md-6">
		                				...
		                				<textarea class="form-control" placeholder="type description {{$i}} here..." name="description[]" rows="5"></textarea>
	                				</div>
	                				@endfor
                				</div>
                			</div>
