            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">All Request List</h1>
                    </div>
                                    ...
                                    <table id="usertable" class="table table-center mb-0 ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$tests->email}}<br>{{$tests->phone}}</td>
                                                <!--<td>{{$tests->number_of_guests}}</td>-->
                                                <!--<td>{{$tests->event_date}}</td>-->
                                                <td style="word-wrap:anywhere;word-break:break-all;">{{$tests->comment}}</td>
                                                <td><a href="{{url('admin/vendor-details')}}/{{$tests->vendor_id}}">{{$tests->business_name}}</a></td>
