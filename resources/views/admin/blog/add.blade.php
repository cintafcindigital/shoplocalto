            ...
            <div class="col-sm-12">
                ...
                <div class="row border-bottom mb-3">
                    ...
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        ...
                        <h1 class="d-inline-block font-weight-normal mb-0">Add New Blog</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xl-12">
                        ...
                        <div class="form-group {{ $errors->has('body') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="body" rows="5" name="body">{{old('body')}}</textarea>
...
<script>
    ...
    $(document).ready(function() {
          ...
          var content = {!! json_encode( old('body') ) !!};
