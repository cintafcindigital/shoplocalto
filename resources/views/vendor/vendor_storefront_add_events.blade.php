   ...
   <div class="wrapper">
	   <div class="pure-g">
	      ...
	      <div class="pure-u-5-7 add_event_page">
	        ...
	        <h1 class="adminTitle">Events <i class="icon icon-arrow-right ml10 mr10"></i>Create</h1>
	               ...
	               <div class="pure-g">
	                  <div class="pure-u-3-5">
	                     <div class="pr20">
	                        ...
	                        <input class="pure-u-1" type="text" value="" name="event_name" id="event_name" maxlenght="100">
	                     </div>
	                  </div>
	               ...
	               <div class="pure-g">
	                  <div class="pure-u event_input">
	                     <div class="pr20">
	                        ...
	                        <div class="mt10 input-append date app-common-datepicker">
	                           <input id="event_start_date" name="event_start_date" type="text" placeholder="dd/mm/yyyy" data-date-weekstart="1" data-date-format="dd/mm/yyyy" readonly="">
	                  ...
	                  <div class="pure-u event_all_input">
                         ...
                         <div class="select-fake mt5 mr5">
                           <select name="event_start_time" id="event_start_time">
                              <option value="-1" selected>- Start Time -</option>
	                  ...
	                  <div class="pure-u event_input">
	                     <div class="pr20">
	                        ...
	                        <div class="mt10 input-append date app-common-datepicker">
	                           <input id="event_end_date" name="event_end_date" type="text" placeholder="dd/mm/yyyy" data-date-weekstart="1" data-date-format="dd/mm/yyyy" readonly="">
	            ...
	            <div class="adminBox">
	               <div class="pure-g-r">
	                       ...
	                       <!--  <div class="pure-control-group">
	                        ...
	                        <div class="pure-control-group">
				                     ...
				                     <div class="drop-wrapper">
				                        ...
				                        <input id="city" name="city" class="pure-u-1 autocomplete_txt" type="text" value="">
				                        <div class="app-suggest-poblacion-div-default droplayer droplayer-scroll dnone"></div>
				                     </div>
				                  </div>
	                        <label class="adminFormLabel" for="Direccion">Address</label>
	                        <input class="pure-u-1" type="text" name="event_address" id="event_address" onchange="updateLatLong();">
	                        <div class="mt20">
	                  ...
	                  <div class="pure-u-2-5">
	                     ...
	                     <div id="gmap" class="mt10 pure-u-1" style="height:180px;"></div>
	                  </div>
	               </div>
	            </div>
	            <div class="adminBox">
	               <div class="pure-g">
	                  <div class="pure-u-3-5">
	                     <div class="pr40">
	                        ...
	                        <textarea id="event_description" name="event_description" class="description" ></textarea>
	                     </div>
	                  </div>
	                  <div class="pure-u-2-5">
	                  ...
	                  <div class="pure-u-1 mt20">
	                     <input type="submit" class="btnFlat btnFlat--primary post_event_btn" value="Post Event">
	                  </div>
	               </div>
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        $(".post_event_btn").click(function(e) {
            e.preventDefault();
