            ...
            <div class="app-hide-alert" style="display: none;">
	         ...
	         <div class="adminBox">
	            <form class="pure-form adminOwners__form" name="formOwner"  method="post" enctype="multipart/form-data">
	                     ...
	                     <div class="pr40">
	                        <div class="pure-g">
	                           <div class="pure-u-1-2 pr20">
	                              ...
	                              <input class="pure-u-1" type="text" name="firstname" id="firstname" value="">
	                           </div>
	                           <div class="pure-u-1-2">
	                              <label class="adminFormLabel" for="ownerSurname">Last Name</label>
	                              <input class="pure-u-1" type="text" name="lastname" id="lastname" value="">
	                           </div>
	                        </div>
	                        <div class="mt10">
	                        ...
	                        <div class="mt10">
	                           ...
	                           <input class="pure-u-1" type="text" name="position" id="position" value="">
	                        </div>
	                        <div class="mt10">
	                           <div class="mb10">
	                              <label class="adminFormLabel" for="ownerBio">Bio</label>
	                           </div>
	                           <textarea class="description form-control" rows="5" id="biography" name="biography"></textarea>
	               ...
	               <div class="mt20">
	                  <input class="btnFlat btnFlat--primary add_team_mem_btn" type="submit" value="Add team member">
	                  <small class="adminOwners__legal">Published content is required to meet My Health Squad Profile. <a href="{{url('privacy-policy')}}" target="_blank">Terms of Use</a>.</small>
	               </div>
	            </form>
	         </div>
	      </div>
...
<script type="text/javascript">
	$(document).ready(function() {
	    $(".add_team_mem_btn").click(function(e) {
            e.preventDefault();
        ...
        $('.crop_image').click(function(event){
		    $image_crop.croppie('result', {
		      ...
		      $('#deal_img').attr('src', response).height(150).width(250);
