    ...
    <div class="wrapper wrapper-blood">
	   <div class="pure-g">
	      <div class="pure-u-2-7">
	         <div class="mr40">
	            <nav class="adminAside reivews_wedding_menu">
	               ...
	               <a class="adminAside__item active" href="{{url('reviews-sellos')}}">
	      ...
	      <div class="pure-u-5-7">
	         <h1 class="adminTitle">MHS ALL STAR TEAM™</h1>
	         <div class="adminAlert adminAlert--flex review_wedding_alert">
	            ...
	            <div>
	               ...
	               <p class="adminAlert__description">Reviews are critical when it comes time to choose a Health professional. Encourage your past clients and patients to leave a review about their experience with your business.</p>
	            </div>
	         ...
	         <div class="pure-g-r-- row mt20-- pb20--">
	            <div class="col-sm-4 mb20--">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     ...
	                     <p class="adminBadgeItem__title">25 reviews</p>
	            ...
	            <div class="col-sm-4 mb20--">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     ...
	                     <p class="adminBadgeItem__title">50 reviews</p>
	                     <p class="adminBadgeItem__text">Get 50 more reviews to earn the Gold MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <div class="col-sm-4 mb20--">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     ...
	                     <p class="adminBadgeItem__title">100 reviews</p>
	                     <p class="adminBadgeItem__text">Get 100 more reviews to earn the Platinum MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <!-- <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--10 award--grey">
	                        <span class="award__count">
	                        10                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">10 reviews</p>
	                     <p class="adminBadgeItem__text">Get 10 more reviews to earn the Silver MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--25 award--grey">
	                        <span class="award__count">
	                        25                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">25 reviews</p>
	            ...
	            <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--50 award--grey">
	                        <span class="award__count">
	                        50                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">50 reviews</p>
	                     <p class="adminBadgeItem__text">Get 50 more reviews to earn the Silver MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--100 award--grey">
	                        <span class="award__count">
	                        100                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">100 reviews</p>
	                     <p class="adminBadgeItem__text">Get 100 more reviews to earn the Silver MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--250 award--grey">
	                        <span class="award__count">
	                        250                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">250 reviews</p>
	                     <p class="adminBadgeItem__text">Get 250 more reviews to earn the Silver MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--500 award--grey">
	                        <span class="award__count">
	                        500                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">500 reviews</p>
	                     <p class="adminBadgeItem__text">Get 500 more reviews to earn the Silver MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--750 award--grey">
	                        <span class="award__count">
	                        750                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">750 reviews</p>
	                     <p class="adminBadgeItem__text">Get 750 more reviews to earn the Silver MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
	            ...
	            <div class="pure-u-1-3 mb20">
	               <div class="box adminBadgeItem">
	                  <div class="adminBadgeItem__content">
	                     <div class="award award--center award--large award--rounded award--1000 award--grey">
	                        <span class="award__count">
	                        1000                                            </span>
	                     </div>
	                     <p class="adminBadgeItem__title">1000 reviews</p>
	                     <p class="adminBadgeItem__text">Get 1000 more reviews to earn the Silver MHS AllStar Team status.</p>
	                  </div>
	                  <div class="adminBadgeItem__footer">
	                     <a href="{{url('reviews')}}" class="btnOutline btnOutline--primary">Request reviews</a>
	                  </div>
