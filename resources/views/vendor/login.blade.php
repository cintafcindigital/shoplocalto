                ...
                <div class="wrapper wrapper--blood">
                    <div class="xxpure-g row">
                        <div class="xxpure-u-2-3 col-sm-6 text-center">
                            ...
                            <a href="{{url('emp-vendor/register')}}" class="adminLandingCta">Claim your listing </a>
                        </div>
                        <div class="xxpure-u-1-3 col-sm-6">
                            <form class="adminAccessLogin adminAccessLogin--right" name="frmAcceso" action="{{url('emp-vendor/login')}}" method="post">
                                {{ csrf_field() }}
                                @if(session()->has('msg'))
                                ...
                                <a class="adminAccessLogin__rememberPass app-va-open-modal" href="{{ url('emp-vendor/password/reset') }}">Forgot your password?</a>
                            </form>
                        </div>
                    </div>
                </div>
...
<section class="about-section">
    <div class="row slideanim slide wrapper wrapper--blood">
        <div class="col-sm-4 col-md-4 about-cot">
            ...
            <h4>Reach potential clients & patients</h4>
        ...
        <div class="col-sm-4 col-md-4 about-cot">
            ...
            <h4>Get clients & patients that are looking for your specific service now.</h4>
...
<section class="about-section-2 visible-xs">
    <div style="height: 161px;padding: 0px;position: relative;padding-bottom: 84%;">
        ...
        <span style="position: absolute;width: 100%;height: 263px;background: #ffffff57;top: 0;bottom: 0;"></span>
        <div style="height: 100%;padding: 12% 7% 7% 7%;position: absolute;top: 0;">
...
<section class="about-section">
    <div class="row wrapper wrapper--blood">
        <div class="col-sm-12">
            <h3 class="text-center" style="padding-bottom: 15px;font-size: 28px;font-weight: normal;">Your Busines Board</h3>
        </div>
        <div class="col-sm-6">
            <p class="icon-with-text"><span class="homeTools__itemIcon homeTools__itemIcon--budget"></span> Get notified when you have messages and requests for further information. Access your Lead Gen Pro account to manage your leads.</p>
        ...
        <div class="col-sm-6">
            <p class="icon-with-text"><span class="homeTools__itemIcon homeTools__itemIcon--com"></span> Use your chat feature and interact in real time with potential clients & patients.</p>
            <p class="icon-with-text"><span class="homeTools__itemIcon homeTools__itemIcon--checklist"></span> Access Your invoice and billing history.</p>
            <p class="icon-with-text"><span class="homeTools__itemIcon homeTools__itemIcon--guests"></span>Request reviews from past clients & patients</p>
        </div>
    </div>
</section>
<section>
    <div class="header-bottom"></div>
    <div id="myCarousel" class="carousel slide inner-slider" data-ride="carousel">
        <div class="carousel-inner" role="listbox" style="position:relative;background-image: url(http://mhs.local/public/images/login-health-page.jpg);background-position: center;    background-size: cover;background-attachment: fixed;">
            <span style="position: absolute;width: 100%;height: 100%;background: #00000045;"></span>
            <div class="container">
                <div class="slider-cont">
                    <h3 style="color: #fff;"><strong>GROW YOUR BUSINESS WITH MY HEALTH SQUAD!</strong></h3>
                    ...
                    <div class=" field-button qc_sign-btn text-center">
                        <a href="{{url('emp-vendor/register')}}" class="btn btn-search">Claim your listing</a>
                    </div>
                </div>
            </div>
