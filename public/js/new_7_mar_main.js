...
(function($) {
    ...
    // NAVBAR SCROLL FOR EVERY SECTION
	...
	$('.app-dropdown-toggle').click(function(){
		$('.app-dropdown-toggle-layer').toggle();
		
	});
	
	$('.dash-cover-edit').click(function(){
		$('#my_file').click();
