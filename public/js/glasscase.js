...
(function ($, window, document, undefined) {
    ...
    GlassCase.defaults = {
        ...
        heightDisplay: 400,        // Default height of the display image
    ...
    GlassCase.prototype = {
        init: function (options) {
            ...
            var ctntDisplayArea = "<div class='gc-display-area'>" +
                                        ...
                                        "<div class='gc-icon gc-icon-next'><i class='fa fa-angle-right'></i></div>" +
                                        "<div class='gc-icon gc-icon-prev'><i class='fa fa-angle-left'></i></div>" +
