                    ...
                    <div class="header-modal-container scrollbar-inner fl-wrap" data-simplebar>
                        ...
                        <div class="widget-posts  fl-wrap">
                            <ul class="no-list-style">
                                <li>
                                    <div class="widget-posts-img"><a href="listing-single.html"><img src="{{asset('images/gallery/thumbnail/1.png')}}" alt=""></a>  
                                    </div>
                    ...
                    <section class="hero-section"   data-scrollax-parent="true">
                        <div class="bg-tabs-wrap">
                            <div class="bg-parallax-wrap" data-scrollax="properties: { translateY: '200px' }">
                                <div class="bg bg_tabs"  data-bg="images/bgimage1.jpg"></div>
                        ...
                        <div class="container small-container">
                            ...
                            <div class="main-search-input-tabs  tabs-act fl-wrap">
                                <ul class="tabs-menu change_bg no-list-style">
                                    <li class="current"><a href="#tab-inpt1" data-bgtab="images/bgimage1.jpg"> Places</a></li>
                                    <li><a href="#tab-inpt2" data-bgtab="images/bgimage1.jpg"> Events</a></li>
                                    <li><a href="#tab-inpt3" data-bgtab="images/bgimage1.jpg"> Restaurants</a></li>
                                    <li><a href="#tab-inpt4" data-bgtab="images/bgimage1.jpg"> Hotels</a></li>
                                </ul>
                                <!--tabs -->                       
                                ...
                                <div class="row">
                                	<div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            ...
                                            <div class="listing-counter color2-bg"><span>8</span> Locations</div>
                                            <div class="listing-item-grid_title">
                                                <h3><a href="listing.html">Liberty Village</a></h3>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/1.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                            <div class="listing-counter color2-bg"><span>124 </span> Locations</div>
                                            <div class="listing-item-grid_title">
                                                <h3><a href="listing.html">Trinity Bellwoods</a></h3>
                                                <p>Constant care and attention to the patients makes good record</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/1.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                            <div class="listing-counter color2-bg"><span>49 </span> Locations</div>
                                            <div class="listing-item-grid_title">
                                                <h3><a href="listing.html">Yorkville</a></h3>
                                                <p>Constant care and attention to the patients makes good record</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/1.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                            <div class="listing-counter color2-bg"><span>56 </span> Locations</div>
                                            <div class="listing-item-grid_title">
                                                <h3><a href="listing.html">Midtown</a></h3>
                                                <p>Constant care and attention to the patients makes good record</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/1.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                            <div class="listing-counter color2-bg"><span>44 </span> Locations</div>
                                            <div class="listing-item-grid_title">
                                                <h3><a href="listing.html">The Beaches</a></h3>
                                                <p>Constant care and attention to the patients makes good record</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="listing-item-grid">
                                            <div class="bg"  data-bg="images/all/1.jpg"></div>
                                            <div class="d-gr-sec"></div>
                                            <div class="listing-counter color2-bg"><span>54 </span> Locations</div>
                                            <div class="listing-item-grid_title">
                                                <h3><a href="listing.html">Parkdale</a></h3>
                                                <p>Constant care and attention to the patients makes good record</p>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="geodir-category-img">
                                                            ...
                                                            <div class="geodir-category-opt">
                                                                ...
                                                                <div class="listing_carditem_footer fl-wrap">
                                                                    ...
                                                                    <div class="post-author"><a href="#"><img src="{{asset('images/avatar/1.jpg')}}" alt=""><span>By , Mark Rose</span></a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </article>
                                                        ...
                                                        <div class="geodir-category-img">
                                                            ...
                                                            <div class="geodir-category-opt">
                                                                ...
                                                                <div class="listing_carditem_footer fl-wrap">
                                                                    ...
                                                                    <div class="post-author"><a href="#"><img src="{{asset('images/avatar/1.jpg')}}" alt=""><span>By , Nasty Wood</span></a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </article>
                                                        ...
                                                        <div class="geodir-category-img">
                                                            ...
                                                            <div class="geodir-category-opt">
                                                                ...
                                                                <div class="listing_carditem_footer fl-wrap">
                                                                    ...
                                                                    <div class="post-author"><a href="#"><img src="{{asset('images/avatar/1.jpg')}}" alt=""><span>By , Kliff Antony</span></a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </article>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                <div class="testi-avatar"><img src="{{asset('images/avatar/1.jpg')}}" alt=""></div>
