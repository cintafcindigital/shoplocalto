                    ...
                    <div class="header-modal-container scrollbar-inner fl-wrap" data-simplebar>
                        ...
                        <div class="widget-posts  fl-wrap">
                            <ul class="no-list-style">
                                <li>
                                    <div class="widget-posts-img"><a href="listing-single.html"><img src="{{assets('images/gallery/thumbnail/1.png')}}" alt=""></a>  
                                    </div>
                    ...
                    <section class="listing-hero-section hidden-section" data-scrollax-parent="true" id="sec1">
                        ...
                        <div class="container">
                            ...
                            <div class="list-single-header_bottom fl-wrap">
                                ...
                                <div class="list-single-author"> <a href="author-single.html"><span class="author_avatar"> <img alt='' src='{{assets('images/avatar/1.jpg')}}'>  </span>By  Alisa Noory</a></div>
                                                        ...
                                                        <div class="swiper-container">
                                                            <div class="swiper-wrapper">
                                                                ...
                                                                <div class="swiper-slide">
                                                                    <div class="box-item">
                                                                        <img  src="{{assets('images/all/1.jpg')}}"   alt="">
                                                                        <a href="{{assets('images/all/1.jpg')}}" class="gal-link popup-image"><i class="fa fa-search"  ></i></a>
                                                                    </div>
                                                                </div>
                                                                <!-- swiper-slide end-->                                                                  
                                                            </div>
                                                    ...
                                                    <div class="reviews-comments-item">
                                                        ...
                                                        <div class="reviews-comments-item-text fl-wrap">
                                                            ...
                                                            <div class="review-images ">
                                                                <a href="images/all/1.jpg" class="image-popup"><img src="{{assets('images/all/1.jpg')}}" alt=""></a>
                                                                <a href="images/all/1.jpg" class="image-popup"><img src="{{assets('images/all/1.jpg')}}" alt=""></a>
                                                            </div>
                                                            <div class="reviews-comments-item-footer fl-wrap">
